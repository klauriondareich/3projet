      ...
      <ion-menu content-id="main-content" type="overlay">
        <ion-content>
          <ion-list id="inbox-list">
            <ion-list-header>3PROJ Mobile</ion-list-header>  
...
import { homeSharp, personSharp, documentSharp } from 'ionicons/icons';
...
export default defineComponent({
  ...
  setup() {
    ...
    const path = window.location.pathname.split('auth/')[1];
    if (path !== undefined) {
